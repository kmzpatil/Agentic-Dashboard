  ...
  try {
    ...
    const journeySql = `
      ...
      output_mix AS (
        ...
        LEFT JOIN created_assets ca ON ca."Video_ID" = rv."Video_ID"
        LEFT JOIN published_posts pp ON pp."Asset_ID" = ca."Asset_ID"
        GROUP BY rv."Video_ID", ca."Output_Type"
      )
...
app.get('/api/funnel/video/:videoId', async (req, res) => {
...
app.get('/api/explorer/dimensions', async (_req, res) => {
  res.json({
    dimensions: [
...
app.get('/api/explorer/multidim', async (req, res) => {
...
app.get('/api/explorer/tables', async (_req, res) => {
  try {
...
app.get('/api/explorer/table/:tableName', async (req, res) => {
...
app.get('/api/explorer/chart', async (req, res) => {
